...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/BillRizer/ia-config/main/install.sh) "$(basename "$PWD")"
```

> Esse comando:
> 1. Baixa os arquivos `.mdc` do repositório `BillRizer/ia-config`
